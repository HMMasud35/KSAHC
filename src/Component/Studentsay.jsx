...
const Studentsay = () => {
  ...
  return (
    <section className="bg-[url(/image-3.jpeg)] bg-no-repeat bg-center bg-cover">
      <div className='w-full h-full bg-gray-950/80 py-30'>
        <div className="container">
          <div className="relative">
            ...
            <div className="mt-20 w-[1100px] m-auto">
              <Swiper ref={sliderRef} autoplay={{ delay: 3000, pauseOnMouseEnter: true }} modules={[Autoplay]}>
                <SwiperSlide>
                  <div className=" rounded-3xl grid grid-cols-3 w-[1080px] h-[420px] px-10 items-center bg-white border-b-4 border-r-4 border-teal-600">
                    <div className='bg-teal-600 rounded-t-full rounded-bl-full  '>
                    ...
                    <div className="col-span-2 text-center">
                      <p className="text-3xl italic relative">
                        <span className='absolute -top-3 -left-8 rotate-y-180'>&part;&part;</span> Masud was outstanding from start to finish. He was professional, helpful, and delivered a high-quality website ahead of schedule and within budget. Couldn’t be happier with the result.”
                      </p>
                      <div className='mt-8'>

...
const Course = () => {
  ...
  return (
    <section>
      <div className='bg-gray-950/80 py-30'>
        {/* <Loading/> */}
        <div className="container">
          <div className='w-200'>
            <h4 className='text-4xl text-teal-600 font-bold mb-2 block pb-3 mr-12 border-teal-600'>বিভাগ সম্পর্কে</h4>
            <h2 className='text-white text-6xl font-bold uppercase leading-15 mb-7'>আমাদের শিক্ষা ব্যবস্থা <span className='text-teal-600'> অনুপ্রাণিত করবে</span></h2>
            <p className='text-2xl text-white/80 mb-10 relative left-5 after:w-2 after:h-15 after:bg-teal-600 after:absolute after:top-1.5 after:left-[-20] after:rounded-full'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Molestiae ratione itaque debitis omnis sunt? Quam impedit corporis unde veritatis culpa!</p>
          </div>
          <div>
            <div className='relative -top-20'>
              <button onClick={handlePrev} className="prev absolute right-30">
              ...
              <button onClick={handleNext} className="next absolute right-4">
                <div className="w-20 flex justify-between items-center h-[50px] rounded-md border-2 border-teal-600 hover:bg-teal-600/20">

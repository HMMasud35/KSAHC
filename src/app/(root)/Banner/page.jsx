      ...
      <div className="container">
        <div className="justify-between items-center absolute top-70 z-10">
          <div className='bg-black/20 w-217 p-10 '>
            <h1 className=' text-6xl font-tirob uppercase leading-17 font-extrabold text-white relative '>কালকিনি  <br /><span className='text-teal-400 [text-shadow:_0_0px_3px_rgb(0_0_0)]'>সৈয়দ আবুল হোসেন</span> কলেজ</h1>
        ...
        <div className='grid grid-cols-4 gap-10 justify-between absolute -bottom-20 right-10 z-10 '>
          <div className='w-80 h-50 rounded-t-4xl p-5 rounded-bl-4xl bg-white grid grid-rows-2 gap-3'>
            <div className='flex justify-between items-center'>
              ...
              <h4 className='text-teal-600 text-6xl font-extrabold '>০১</h4>
            </div>
            <div>
              <h3 className="text-xl font-bold">বৃত্তি সুবিধা</h3>
          ...
          <div className='w-80 h-50 rounded-t-4xl p-5 rounded-bl-4xl bg-white grid grid-rows-2 gap-3'>
            <div className='flex justify-between items-center'>
              ...
              <h4 className='text-teal-600 text-6xl font-extrabold '>০২</h4>
            </div>
            <div>
              <h3 className="text-xl font-bold">দক্ষ প্রভাষক</h3>
              <p>Lorem ipsum dolor sit amet conseetur adipisicing.</p>
            </div>
          </div>
          <div className='w-80 h-50 rounded-t-4xl p-5 rounded-bl-4xl bg-white grid grid-rows-2 gap-3'>
            <div className='flex justify-between items-center'>
              ...
              <h4 className='text-teal-600 text-6xl font-extrabold '>০৩</h4>
            </div>
            <div>
              <h3 className="text-xl font-bold">বই পাঠাগার সুবিধা</h3>
              <p>Lorem ipsum dolor sit amet conseetur adipisicing.</p>
            </div>
          </div>
          <div className='w-80 h-50 rounded-t-4xl p-5 rounded-bl-4xl bg-white grid grid-rows-2 gap-3'>
            <div className='flex justify-between items-center'>
              ...
              <h4 className='text-teal-600 text-6xl font-extrabold '>০৪</h4>
            </div>
            <div>
              <h3 className="text-xl font-bold">সাশ্রয়ী মূল্য</h3>
              <p>Lorem ipsum dolor sit amet conseetur adipisicing.</p>
            </div>
          </div>
